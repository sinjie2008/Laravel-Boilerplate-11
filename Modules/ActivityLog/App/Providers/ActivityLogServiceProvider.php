...
use Illuminate\Support\Facades\Event; // Add Event facade
use Illuminate\Auth\Events\Login;     // Add Login event
use Illuminate\Auth\Events\Logout;    // Add Logout event
