        ...
        <form action="{{ route('admin.plans.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="api_call_limit_per_day" id="api_call_limit_per_day" min="0" class="form-control @error('api_call_limit_per_day') is-invalid @enderror" value="{{ old('api_call_limit_per_day') }}" required>
