    ...
    <div class="card">
        ...
        <form action="{{ route('admin.subscriptions.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                <x-adminlte-input-date name="starts_at" label="Starts At" :config="['format' => 'YYYY-MM-DD HH:mm:ss']" placeholder="Choose a start date..." value="{{ old('starts_at', now()->format('Y-m-d H:i:s')) }}">
                ...
                <x-adminlte-input-date name="ends_at" label="Ends At (Optional)" :config="['format' => 'YYYY-MM-DD HH:mm:ss']" placeholder="Choose an end date..." value="{{ old('ends_at') }}">
                    <x-slot name="prependSlot">
                        <div class="input-group-text bg-gradient-info">
                            <i class="fas fa-calendar-alt"></i>
                        </div>
